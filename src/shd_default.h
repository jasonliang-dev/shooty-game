...
/*
    ...
    Cmdline: sokol-shdc -i src\default.glsl -o src\shd_default.h -l glsl330:glsl100:hlsl4 -b -f sokol_impl
...
/*
    ...
    void main()
    {
        ...
        if (_25.w < 0.100000001490116119384765625)
        {
            discard;
        }
        f_color = _25 + v_fog;
...
*/
static const char frag_source_glsl330[334] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    ...
    0x20,0x20,0x20,0x66,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x5f,0x32,0x35,
    0x20,0x2b,0x20,0x76,0x5f,0x66,0x6f,0x67,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
/*
    #version 100
...
*/
static const char frag_source_glsl100[401] = {
    ...
    0x5f,0x32,0x35,0x20,0x2b,0x20,0x76,0x5f,0x66,0x6f,0x67,0x3b,0x0a,0x7d,0x0a,0x0a,
    0x00,
};
/*
    ...
    #line 20 "src\default.glsl"
    void vert_main()
    {
    #line 20 "src\default.glsl"
        v_texindex = a_texindex;
    #line 21 "src\default.glsl"
        v_color = a_color;
    #line 22 "src\default.glsl"
        v_fog = a_fog;
    #line 23 "src\default.glsl"
...
/*
    ...
    #line 15 "src\default.glsl"
    void frag_main()
    {
    #line 15 "src\default.glsl"
        float4 _21 = u_texture.Sample(_u_texture_sampler, v_texindex);
        float4 _25 = _21 * v_color;
    #line 16 "src\default.glsl"
        if (_25.w < 0.100000001490116119384765625f)
        {
    #line 17 "src\default.glsl"
            discard;
        }
    #line 19 "src\default.glsl"
        f_color = _25 + v_fog;
    }
...
static const uint8_t frag_bytecode_hlsl4[744] = {
    0x44,0x58,0x42,0x43,0xe6,0x8d,0x8b,0x76,0xd8,0xa9,0x16,0xbc,0x77,0x53,0xc4,0xe2,
    0x71,0x55,0x06,0xa2,0x01,0x00,0x00,0x00,0xe8,0x02,0x00,0x00,0x05,0x00,0x00,0x00,
    ...
    0x01,0x40,0x00,0x00,0xcd,0xcc,0xcc,0x3d,0x0d,0x00,0x04,0x03,0x0a,0x00,0x10,0x00,
